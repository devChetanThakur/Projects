    ...
    <div className='eyes w-full h-screen overflow-hidden'>
      <div data-scroll data-scroll-section data-scroll-speed="-.7" className='relative w-full h-full bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")]'>
          ...
          <div className='absolute flex top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] gap-10'>
            <div className='w-[15vw] h-[15vw] flex items-center justify-center bg-zinc-200 rounded-full'>
              <div className=' items-center  justify-center relative w-2/3 h-2/3 bg-zinc-900 rounded-full'>
